...
typealias User = BikeSchemaV2.User
typealias AuthenticatedUser = BikeSchemaV2.AuthenticatedUser

extension BikeSchemaV2 {
    ...
    @Model final class User {
        ...
        init(
            email: String, username: String, name: String, additionalEmails: [String],
            createdAt: Date,
