...
#
alias ictool="/Applications/Xcode_27.0.app/Contents/Applications/Icon\ Composer.app/Contents/Executables/ictool"
...
open BikeIndex/Assets.xcassets -a /Applications/Xcode_27.0.app
