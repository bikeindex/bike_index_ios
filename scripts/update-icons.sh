...
#
alias ictool="/Applications/Xcode-26.6.0.app/Contents/Applications/Icon\ Composer.app/Contents/Executables/ictool"
...
open BikeIndex/Assets.xcassets -a /Applications/Xcode-26.6.0.app
